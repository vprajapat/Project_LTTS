                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="time" name="depart_time" class="form-control" required data-validation-required-message="This field is required"  value="{{$trains_schedule->depart_time}}"> </div>
                        </div>
                        <span class="text-danger">
                            @error('depart_time')
                                {{$message}}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="date" name="depart_date" class="form-control" required data-validation-required-message="This field is required"  value="{{$trains_schedule->depart_date}}"> </div>
                        </div>
                        <span class="text-danger">
                            @error('depart_date')
                                {{$message}}
